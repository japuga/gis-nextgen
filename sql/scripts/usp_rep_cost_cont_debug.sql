...
/****** Object:  StoredProcedure [dbo].[usp_rep_cost_cont_debug]    Script Date: 08/05/2018 11:46:29 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_rep_cost_cont_debug]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_rep_cost_cont_debug]
GO
...
(
cust_id CHAR(2),
cust_report_name NVARCHAR(50), 
store_number CHAR(20), 
store_id INT, 
store_address CHAR(80), 
store_city CHAR(40), 
state_id CHAR(2), 
store_co_code CHAR(15), 
store_name CHAR(80), 
vend_name CHAR(60), 
vend_seq INT, 
account_no CHAR(30),
invoice_no CHAR(30), 
vinvoice_date SMALLDATETIME, 
period_seq INT,
old_rate DECIMAL(10,2), 
rate DECIMAL(10,2), 
glm_rate DECIMAL(10,2),  
...
load_id CHAR(3),
eqpt_temp CHAR(1),
content_desc CHAR(30), 
serv_desc CHAR(40), 
rate_status CHAR(1), 
eqpt_mask CHAR(50),
frequency_mask CHAR(60),
contract_range CHAR(50) DEFAULT '',
serv_usage DECIMAL(10,4) DEFAULT 0.00,
units CHAR(100) DEFAULT ' ',
comment CHAR(80) DEFAULT ' ',
total_units DECIMAL(14,4) DEFAULT 0.00,
total_serv DECIMAL(7,2) DEFAULT 0.00,
total_glmrate_serv DECIMAL(7,2) DEFAULT 0.00,
savings DECIMAL(7,2) DEFAULT 0.00,
non_bill_savings DECIMAL(7,2) DEFAULT 0.00,
current_glmrate_savings DECIMAL(7,2) DEFAULT 0.00,
glm_savings DECIMAL(7,2) DEFAULT 0.00,
contract_opening_date CHAR(10) DEFAULT ' ',
contract_expiration_date CHAR(10)DEFAULT ' ',
total_charges DECIMAL(12,2) DEFAULT 0.00,
total_glmrate_charges DECIMAL(12,2) DEFAULT 0.00,
total_savings DECIMAL(12,2) DEFAULT 0.00,
total_nonbillsavings DECIMAL(12,2) DEFAULT 0.00,
total_current_glmrate_savings DECIMAL(12,2) DEFAULT 0.00,
total_savingsPercent DECIMAL(12,2) DEFAULT 0.00,
total_taxes DECIMAL(12,2) DEFAULT 0.00,
store_savings DECIMAL(12,2) DEFAULT 0.00,
store_total DECIMAL(12,2) DEFAULT 0.00,
...
serv_desc4 CHAR(30) DEFAULT ' ',
serv_desc5 CHAR(30) DEFAULT ' ',
serv_desc6 CHAR(30) DEFAULT ' ',
serv_desc7 CHAR(30) DEFAULT ' ',
serv_desc8 CHAR(30) DEFAULT ' ',
serv_desc9 CHAR(30) DEFAULT ' ',
serv_desc10 CHAR(30) DEFAULT ' ',
serv_desc11 CHAR(30) DEFAULT ' ',
serv_desc12 CHAR(30) DEFAULT ' ',
serv_desc13 CHAR(30) DEFAULT ' ',
serv_desc14 CHAR(30) DEFAULT ' ',
serv_desc101 CHAR(30) DEFAULT ' ',
serv_desc102 CHAR(30) DEFAULT ' ',
serv_desc103 CHAR(30) DEFAULT ' ',
serv_desc104 CHAR(30) DEFAULT ' ',
serv_desc105 CHAR(30) DEFAULT ' ',
serv_desc106 CHAR(30) DEFAULT ' ',
serv_desc107 CHAR(30) DEFAULT ' ',
serv_sum1 decimal(14,4) DEFAULT 0.00,
serv_sum2 decimal(14,4) DEFAULT 0.00,
serv_sum3 decimal(14,4) DEFAULT 0.00,
serv_sum4 decimal(14,4) DEFAULT 0.00,
serv_sum5 decimal(14,4) DEFAULT 0.00,
serv_sum6 decimal(14,4) DEFAULT 0.00,
serv_sum7 decimal(14,4) DEFAULT 0.00,
serv_sum8 decimal(14,4) DEFAULT 0.00,
serv_sum9 decimal(14,4) DEFAULT 0.00,
serv_sum10 decimal(14,4) DEFAULT 0.00,
serv_sum11 decimal(14,4) DEFAULT 0.00,
serv_sum12 decimal(14,4) DEFAULT 0.00,
serv_sum13 decimal(14,4) DEFAULT 0.00,
serv_sum14 decimal(14,4) DEFAULT 0.00,
serv_sum101 decimal(14,4) DEFAULT 0.00,
serv_sum102 decimal(14,4) DEFAULT 0.00,
serv_sum103 decimal(14,4) DEFAULT 0.00,
serv_sum104 decimal(14,4) DEFAULT 0.00,
serv_sum105 decimal(14,4) DEFAULT 0.00,
serv_sum106 decimal(14,4) DEFAULT 0.00,
serv_sum107 decimal(14,4) DEFAULT 0.00 
);

SET @sFilter = ''
IF @sStateId <> 'All'
BEGIN  
  SET @sFilter = @sFilter + N'AND s.state_id = ''' + RTRIM (@sStateId)+''' '
END
...
SET @sStmt =N'INSERT INTO #tmpInvoice (' +
'cust_id , cust_report_name , store_number,' +
'store_id, store_address, store_city,' +
'state_id, store_co_code, store_name,' +
'vend_name, vend_seq, account_no,' +
'invoice_no, vinvoice_date, period_seq,' +
'old_rate, rate, glm_rate,' +
'current_rate, eqpt_seq, serv_id,' +
'unit_type, eqpt_qty, eqpt_desc,' +
...
'    vb.vend_name, vb.vend_seq, ' +
'    vi.account_no, ' +
'    vi.invoice_no, vi.vinvoice_date, vi.period_seq, ' +
'    vid.old_rate, vid.rate, vid.glm_rate, ' +
'    vid.rate AS current_rate, ' +
'    vid.eqpt_seq, vid.serv_id, vid.unit_type, ' +
'    se.eqpt_qty, se.eqpt_desc, ' +
'    se.load_id,se.eqpt_temp, ' +
'    co.content_desc, serv.serv_desc, ' +
'    vc.rate_status, ' +
'    dbo.format_eqpt (se.eqpt_qty, se.eqpt_desc, se.load_id) AS eqpt_mask,' +
'    CAST(dbo.format_freq2 (f.freq_sched_flag,  ' +
'       f.freq_times_flag, vc.freq_times, ' +
'       ISNULL(vc.freq_period,''''), ISNULL(vc.freq_day1,''''), ' +
'       ISNULL(vc.freq_day2,''''), ISNULL(vc.freq_day3,''''), ' +
'       ISNULL(vc.freq_day4,''''), ISNULL(vc.freq_day5,''''), ' +
...
'    AND vi.vend_seq = vb.vend_seq ' + 
'    AND se.content_id = co.content_id ' +
'    AND vi.cust_id = se.cust_id ' +
'    AND vi.store_id = se.store_id ' +
'    AND vid.eqpt_seq = se.eqpt_seq ' +
'    AND vi.invoice_no = vid.invoice_no ' +
'    AND vi.cust_id = vid.cust_id ' +
'    AND vi.store_id = vid.store_id ' +
'    AND vi.account_no = vid.account_no ' +
'    AND vi.vend_seq = vid.vend_seq ' +
'    AND vid.cust_id = vc.cust_id ' +
'    AND vid.store_id = vc.store_id ' +
'    AND vid.vend_seq = vc.vend_seq ' +
'    AND vid.eqpt_seq = vc.eqpt_seq ' +
'    AND vid.serv_id = vc.serv_id ' +
'    AND vc.freq_id = f.freq_id ' +
'    AND vid.serv_id = serv.serv_id ' +
'    AND vi.cust_id = ''' + @sCustId + '''' +
'    AND s.store_status = ''A''' 

SET @sStmt= RTRIM(@sStmt) + RTRIM(@sFilter) 

print 'STATEMENT 1 Begin --'
print @sStmt +'----'
print 'STATEMENT 1 end ---'
EXEC sp_executesql @sStmt 
...
'    NULL content_desc, serv.serv_desc, ' +
'    NULL rate_status, ' +
...
print '10.End:'+convert(char(30),getdate(),13)
