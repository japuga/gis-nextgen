...
/****** Object:  StoredProcedure [dbo].[usp_rep_cost_cont]    Script Date: 08/05/2018 12:00:35 ******/
...
AS
--CHANGES
--08.05.18  Print Billing Period instead of Invoice
...
BEGIN   
   EXEC usp_get_period_name_by_id @nPeriodSeq, @sPeriodName OUTPUT
